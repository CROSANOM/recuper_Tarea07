...
/**
 * Clase que nos permite leer datos por teclado asegurándose que el tipo de
 * dato introducido es compatible con el esperado.
 * 
 * @author pepino
 */
public class Entrada {
	...
	/**
	 * Método estático que lee un real (float) por teclado y se asegura que el
	 * valor introducido es compatible con un real
	 * 
	...
	/**
	 * Método estático que lee un real de doble precisión (double) por
	 * teclado y se asegura que el valor introducido es compatible con un real
	 * de doble precisión
	 * 
	...
	/**
	 * Método estático que lee un caracter por teclado y se asegura que el
	 * valor introducido es compatible con un caracter
	 * 
